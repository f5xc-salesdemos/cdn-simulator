...
description: >-
  ...
  de 25 Go avec prévention du thundering herd, pool de connexions persistantes
  en amont, 67+ en-têtes de fournisseurs CDN
  d'Akamai/Cloudflare/CloudFront/Fastly/Azure Front Door, et détection des
  appareils. Vérifié lors d'un test de charge continu de 48 heures à un pic de
  170 000 req/s.
sidebar:
  order: 4
i18n:
