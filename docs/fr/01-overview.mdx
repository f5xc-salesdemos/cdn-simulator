...
description: >-
  ...
  conception modulaire du simulateur de nœud CDN Edge basé sur NGINX déployé sur
  Ubuntu 24.04 dans Azure
sidebar:
  order: 1
i18n:
...
4. **Déploiement simple** — `apt install nginx` sur Ubuntu 24.04, deux directives suffisent pour activer la mise en cache
