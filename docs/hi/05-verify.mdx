...
title: सत्यापन
description: >-
  अपेक्षित HTTP रिस्पॉन्स कोड, X-Cache-Status हेडर मान (HIT/MISS), हेल्थ चेक
  JSON रिस्पॉन्स, कैश डायरेक्टरी निरीक्षण, ऑरिजिन कनेक्टिविटी जाँच, और
  cloud-init, NGINX स्टार्टअप, तथा NSG समस्याओं के लिए समस्या निवारण के साथ
  स्मोक टेस्ट कमांड
sidebar:
  order: 5
i18n:
