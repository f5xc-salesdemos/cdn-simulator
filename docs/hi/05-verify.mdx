...
डिप्लॉयमेंट के बाद, CDN एज नोड सही ढंग से काम कर रहा है यह पुष्टि करने के लिए ये जाँचें चलाएँ। cloud-init द्वारा NGINX की इंस्टॉलेशन पूरी होने के लिए `terraform apply` के बाद 2-3 मिनट का समय दें।
...
किसी भी पथ के लिए पहला अनुरोध कैश मिस होगा — एज ऑरिजिन से डेटा लाता है:
...
`MISS` का अर्थ है कि सामग्री कैश में नहीं थी और ऑरिजिन सर्वर से लाई गई।
...
`HIT` पुष्टि करता है कि प्रतिक्रिया ऑरिजिन से संपर्क किए बिना NGINX डिस्क कैश से परोसी गई।

## कैश डायरेक्टरी निरीक्षण

डिस्क पर कैश की गई सामग्री मौजूद है यह सत्यापित करने के लिए VM में SSH करें:
...
यदि cloud-init त्रुटियाँ रिपोर्ट करता है:
...
एक पूर्ण अनुरोध चक्र चलाएँ और प्रतिक्रिया श्रृंखला सत्यापित करें:
...
सभी CDN वेंडर हेडर्स इंजेक्ट हो रहे हैं यह सत्यापित करने के लिए `/headers` पथ का अनुरोध करें (जब ऑरिजिन के रूप में httpbin.org का उपयोग कर रहे हों):

```bash
curl -s "http://<PUBLIC_IP>/headers" | python3 -m json.tool
```

अपेक्षित प्रतिक्रिया में सभी पाँच वेंडर्स के हेडर्स शामिल हैं:
...
`terraform apply` के बाद, cloud-init को 2-3 मिनट लगते हैं। प्रगति जाँचें:
...
- सत्यापित करें कि ऑरिजिन कैश करने योग्य रिस्पॉन्स कोड (200, 301, 302) लौटाता है
- जाँचें कि ऑरिजिन `Cache-Control: no-cache` या `no-store` हेडर्स नहीं भेजता
