...
2. **F5 XC इंसर्शन** — CDN और ऑरिजिन के बीच F5 XC HTTP लोड बैलेंसर इंसर्ट किया जाता है (सुरक्षा डेमो)

बेसलाइन स्थापित करने के लिए प्रत्यक्ष एकीकरण से शुरू करें, फिर तैयार होने पर F5 XC इंसर्ट करें।

## ऑरिजिन सर्वर संदर्भ

[origin-server](https://f5xc-salesdemos.github.io/origin-server/) लैब कंपोनेंट सुरक्षा परीक्षण के लिए संवेदनशील वेब एप्लिकेशन प्रदान करता है।
...
ऑरिजिन-सर्वर के प्रकाशित मैनिफेस्ट से वर्तमान एप्लिकेशन कैटलॉग प्राप्त करें:
...
मैनिफेस्ट सभी एप्लिकेशन पथ, हेल्थ चेक, कंटेनर इमेज, और डेमो फीचर मैपिंग को सूचीबद्ध करता है।

### एप्लिकेशन पथ

| पथ | एप्लिकेशन | डेमो फीचर |
|---|---|---|
| `/` | लैंडिंग पेज | — |
| `/health` | हेल्थ चेक | — |
...
सभी पथों को HTTP 200 लौटाना चाहिए (DVWA फॉलो करने पर 302 फिर 200 लौटाता है)।
...
ऑरिजिन लॉग में CDN एज IP को कनेक्टिंग क्लाइंट के रूप में दिखाना चाहिए, जबकि वास्तविक क्लाइंट IP `X-Forwarded-For` और वेंडर-विशिष्ट हेडर में वहन किया जाता है।
...
बेसलाइन परीक्षण के बाद, CDN और ऑरिजिन के बीच F5 XC HTTP लोड बैलेंसर इंसर्ट करें:
...
2. **CDN एज अपडेट करें** ताकि यह सीधे ऑरिजिन के बजाय F5 XC VIP की ओर पॉइंट करे:
...
| **Origin Server** | [origin-server](https://github.com/f5xc-salesdemos/origin-server) | संवेदनशील वेब ऐप्स |
| **F5 XC Config** | विभिन्न (waf, api-protection, bot-*, आदि) | सुरक्षा नीतियाँ |

प्रत्येक कंपोनेंट ऐसा दस्तावेज़ीकरण प्रकाशित करता है जिसे AI सहायक इंफ्रास्ट्रक्चर डिप्लॉय करने के लिए पढ़ते हैं। ऑरिजिन-सर्वर एक [endpoint manifest](https://github.com/f5xc-salesdemos/origin-server/releases/latest) GitHub Release आर्टिफैक्ट के रूप में प्रकाशित करता है जो सभी एप्लिकेशन पथ और हेल्थ चेक सूचीबद्ध करता है।
