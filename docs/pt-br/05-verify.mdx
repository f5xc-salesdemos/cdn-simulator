...
title: Verificar
description: >-
  Comandos de smoke test com códigos de resposta HTTP esperados, valores do
  cabeçalho X-Cache-Status (HIT/MISS), resposta JSON de verificação de
  integridade, inspeção do diretório de cache, verificações de conectividade com
  a origem e solução de problemas para cloud-init, inicialização do NGINX e
  problemas de NSG
sidebar:
  order: 5
i18n:
